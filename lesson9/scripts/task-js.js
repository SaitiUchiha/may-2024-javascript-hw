...
// div.style.background = '#5600B8'; // дивитися ще в стилях в HTML
// div.style.color = '#FFFFFF'; // дивитися ще в стилях в HTML
// div.style.fontSize = '22px'; // дивитися ще в стилях в HTML
div.innerText = 'qszsh';
...
let ulInfo = document.getElementsByClassName('info')[0];
...
for (const simpson of simpsons) {
    ...
    h2.innerText = simpson.age + ' years old';
    let p = document.createElement('p');
...
// const block = document.getElementsByClassName('member');

// function maxHeaightBlock(block) {
//     let maxHeight = [];
//     for (i = 0; i < divs.length; i++) {
//         maxHeight.push(block[i].offsetHeight);
//     }
//     return maxHeight
// }
//
// console.log(maxHeaightBlock(block));
...
for (const element of block) {
   ...
   divHeight.style.height = JSON.stringify(biggestHeight);
}

...
for (let Pirates = 0; Pirates < WorstGenerationArray2.length; Pirates++) {
    document.write(`<div>
                        <h2>${WorstGenerationArray2[Pirates].name} Посада - ${WorstGenerationArray2[Pirates].position}, вік - ${WorstGenerationArray2[Pirates].age} - ${Pirates}</h2>
                    </div>`);
